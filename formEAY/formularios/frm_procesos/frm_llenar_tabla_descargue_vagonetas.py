...
class LlenarTablaDescargueVagonetas(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.grid_tabla.SetColLabelValue(1, u"Calidad")
        ...
        if self.checkList_producto.IsChecked(indice_checkeado):
            ...
            for i in range(1, cant_columnas):
                ...
                if dato == cad_checkeado:
                    ...
                    puntero_columna_totales = ManipularGrillas.delColumna(self.m_grid_totales, posicion-2)  ## -2 porque grid_tabla empieza en la tercera columna
    ...
    def checkList_vagonetaOnCheckListBoxToggled(self, event):
        ...
        if self.checkList_vagoneta.IsChecked(indice_checkeado):
            ...
            self.grid_tabla.SetCellValue(self.puntero_fila - 1, 1, 'Primera')

            self.puntero_fila = ManipularGrillas.nuevaFilaVaciaGrilla(self.grid_tabla, self.puntero_fila)
            self.grid_tabla.SetCellValue(self.puntero_fila - 1, 0, cad_checkeado)
            self.grid_tabla.SetCellValue(self.puntero_fila - 1, 1, 'Segunda')

            self.puntero_fila = ManipularGrillas.nuevaFilaVaciaGrilla(self.grid_tabla, self.puntero_fila)
            self.grid_tabla.SetCellValue(self.puntero_fila - 1, 0, cad_checkeado)
            self.grid_tabla.SetCellValue(self.puntero_fila - 1, 1, 'Rotos')
