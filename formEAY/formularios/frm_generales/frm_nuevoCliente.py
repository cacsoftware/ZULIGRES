...
class NuevoCliente(wx.Frame):

    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Nuevo Cliente", pos=wx.DefaultPosition,
    ...
    def btn_guardarOnButtonClick(self, event):
        ...
        if rta == 1:
            ...
            cad_sql = """
                    INSERT INTO cliente (nit, razon_social, nom, ape1, ape2, celular, dir, ciudad)
                                        VALUES  ( '{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}' )        
            """.format(nit, razonsocial, nom, ape1, ape2, celular, dir, ciudad)


            Ejecutar_SQL.insert_filas(cad_sql.upper(), 'frm_nuevoCliente/btn_guardarOnButtonClick', BasesDeDatos.DB_PRINCIPAL)

            wx.MessageBox(u'El Cliente fue guardado correctamente', u'Atención', wx.OK | wx.ICON_INFORMATION)
